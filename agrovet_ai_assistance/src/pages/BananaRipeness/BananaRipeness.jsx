  ...
  return (
    <Layout>
      <div className="banana-container">
        <div className="banana-max-width">
          {/* Header */}
          <div className="banana-header">
            <div className="banana-title-wrapper">
              <Apple className="icon-lg text-yellow-600" />
              <h1 className="banana-title">Banana Ripeness Detection</h1>
            </div>
            <h2 className="banana-subtitle">Perfect Timing for Perfect Bananas</h2>
            <p className="banana-description">
              Determine the perfect ripeness level of your bananas for different uses. Our AI analyzes color, 
              texture, and visual cues to help you choose bananas at their optimal stage for eating fresh, 
              cooking, or baking.
            </p>
            <div className="banana-info-box">
              <p className="banana-info-text">
                Banana ripeness affects taste, texture, and nutritional content. Each stage has its perfect use - 
                from cooking with green bananas to making smoothies with overripe ones!
              </p>
            </div>
          ...
          {/* Ripeness Scale */}
          <div className="ripeness-scale-section">
            <h3 className="ripeness-scale-title">Banana Ripeness Scale:</h3>
            <div className="ripeness-scale-grid">
              <div className="ripeness-card ripeness-card-green">
                <div className="ripeness-card-header">
                  <div className="ripeness-indicator ripeness-indicator-green"></div>
                  <span className="ripeness-card-label ripeness-card-label-green">Underripe</span>
                </div>
                <p className="ripeness-card-description ripeness-card-description-green">
                  Firm, starchy, great for cooking
                </p>
              </div>
              <div className="ripeness-card ripeness-card-yellow">
                <div className="ripeness-card-header">
                  <div className="ripeness-indicator ripeness-indicator-yellow"></div>
                  <span className="ripeness-card-label ripeness-card-label-yellow">Perfect Ripe</span>
                </div>
                <p className="ripeness-card-description ripeness-card-description-yellow">
                  Sweet, soft, ideal for eating fresh
                </p>
              </div>
              <div className="ripeness-card ripeness-card-amber">
                <div className="ripeness-card-header">
                  <div className="ripeness-indicator ripeness-indicator-amber"></div>
                  <span className="ripeness-card-label ripeness-card-label-amber">Overripe</span>
                </div>
                <p className="ripeness-card-description ripeness-card-description-amber">
                  Very sweet, perfect for baking
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="upload-section">
            <p className="upload-label">Upload an image of your banana:</p>
            <ImageUpload
              onImageSelect={handleImageSelect}
              onAnalyze={handleAnalyze}
              isAnalyzing={isAnalyzing}
          ...
          {analysisResult && (
            <div className="analysis-results">
              <div className="analysis-header">
                ...
                <h3 className="analysis-title">Banana Analysis Complete</h3>
              </div>
              ...
              <div className="analysis-grid">
                ...
                <div className="result-main">
                  <div className={`result-card ${analysisResult.bgColor}`}>
                    <div className="result-emoji">{analysisResult.icon}</div>
                    <h4 className={`result-stage ${analysisResult.textColor}`}>
                      {analysisResult.stage}
                    </h4>
                    <div className={`result-confidence ${analysisResult.textColor}`}>
                      {analysisResult.confidence}%
                    </div>
                  ...
                  <div className="result-stats">
                    <div className="stat-item">
                      <div className="stat-row">
                        <span className="stat-label">Sugar Content:</span>
                        <span className="stat-value">{analysisResult.sugarContent}</span>
                      </div>
                    </div>
                    <div className="stat-item">
                      <div className="stat-row">
                        <span className="stat-label">Firmness:</span>
                        <span className="stat-value">{analysisResult.firmness}</span>
                      </div>
                    </div>
                    <div className="stat-item">
                      <div className="stat-row">
                        <span className="stat-label">Shelf Life:</span>
                        <span className="stat-value">{analysisResult.shelfLife}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="result-details">
                  <div>
                    <p className={`result-description ${analysisResult.textColor} ${analysisResult.bgColor}`}>
                      {analysisResult.description}
                    </p>
                  </div>
                  ...
                  <div className="detail-grid">
                      ...
                      <div className="detail-list">
                        {analysisResult.characteristics.map((char, index) => (
                          <div key={index} className="detail-list-item">
                            <div className="list-bullet list-bullet-gray"></div>
                            {char}
                          </div>
                        ))}
                      </div>
                    ...
                    <div className="detail-card">
                      ...
                      <div className="detail-list">
                        {analysisResult.uses.map((use, index) => (
                          <div key={index} className="detail-list-item">
                            <div className="list-bullet" style={{ backgroundColor: analysisResult.color }}></div>
                            {use}
                          </div>
                        ))}
                      </div>
                  ...
                  {/* Nutritional Information */}
                  <div className={`nutritional-box ${analysisResult.bgColor}`}>
                    <h5 className={`nutritional-title ${analysisResult.textColor}`}>
                      <AlertTriangle className="detail-icon" />
                      Nutritional Highlights
                    </h5>
                    <p className="nutritional-text">{analysisResult.nutritionalValue}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="fun-facts-section">
                <h5 className="fun-facts-title">🍌 Did You Know?</h5>
