...
const TomatoRipeness = () => {
  ...
  return (
    <Layout>
      <div className="tomato-ripeness-page">
        <div className="container">
          {/* Header */}
          <div className="header-section">
            <div className="header-title">
              <Cherry className="header-icon" />
              <h1>Know Your Tomatoes</h1>
            </div>
            <h2 className="subtitle">Upload an Image for Ripeness Detection</h2>
          ...
          {/* Ripeness Stages */}
          <div className="ripeness-stages-grid">
            {ripenessStages.map((stage, index) => (
              <div key={index} className="stage-card">
                <div className="stage-header">
                  <div className={`stage-indicator ${stage.colorClass}`}></div>
          ...
          <div className="info-box">
            <p>Let our tool be your guide to enjoying tomatoes at their finest!</p>
          </div>

          {/* Upload Section */}
          <div className="upload-section">
            <p className="upload-label">Upload an image of your tomato:</p>
            <ImageUpload
              onImageSelect={handleImageSelect}
              onAnalyze={handleAnalyze}
              isAnalyzing={isAnalyzing}
          ...
          {analysisResult && (
            <div className="analysis-results">
              <div className="results-header">
                ...
                <h3>Tomato Analysis Complete</h3>
              </div>
              ...
              <div className="results-grid">
                ...
                <div className="result-main">
                  <div className={`result-card ${analysisResult.bgColor}`}>
                    <div className="tomato-icon">{analysisResult.icon}</div>
                  ...
                  <div className="nutritional-card">
                    <h5 className="nutritional-title">
                      <Star className="star-icon" />
                      Nutritional Value
                    </h5>
                    <p>{analysisResult.nutritionalValue}</p>
                  </div>
                </div>

                {/* Detailed Information */}
                <div className="result-details">
                  <div className={`description-box ${analysisResult.bgColor}`}>
                    {analysisResult.description}
                  </div>
